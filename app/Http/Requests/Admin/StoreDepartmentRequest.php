...
class StoreDepartmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'installments_en'=> ['nullable'],
            'installments_ar'=> ['nullable'],
            'graduation_en'=> ['nullable'],
            'graduation_ar'=> ['nullable'],
            'admission_en'=> ['nullable'],
            'admission_ar'=> ['nullable'],
            'scholarships_en'=> ['nullable'],
            'scholarships_ar'=> ['nullable'],
            'employe_link'=> ['nullable'],
            'graduate_link'=> ['nullable'],
