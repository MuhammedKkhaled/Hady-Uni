...
class SustainablesGalleryController extends Controller
{
    ...
    {
        $gallery = SustainablesGallery::get();

        return DataTables::of($gallery)

            ->addColumn('record_select', 'admin.galleries.data_table.record_select')
            ->editColumn('department_id' ,function (SustainablesGallery $gallery){
                return $gallery->department->{'titel_'.LaravelLocalization::getCurrentLocale()};
            })
            ->editColumn('created_at', function (SustainablesGallery $gallery) {
