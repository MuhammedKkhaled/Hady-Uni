...
class SustainableController extends Controller
{
    ...
    public function data()
    {
        ...
        return DataTables::of($sustainable)
            ...
            ->editColumn('sustainable_definition_'.LaravelLocalization::getCurrentLocale(), function (Sustainable $sustainable) {
                $text = $sustainable->{"sustainable_definition_".LaravelLocalization::getCurrentLocale()};
