    ...
    <script>
        ...
        let rolesTable = $('#{{$name}}-table').DataTable({
            ...
            columns: [
                ...
                {data: 'specialization_' + '{{ LaravelLocalization::getCurrentLocale() }}', name: 'specialization_' + '{{ LaravelLocalization::getCurrentLocale() }}', searchable: false},
                {data: 'brief_' + '{{ LaravelLocalization::getCurrentLocale() }}', name: 'brief_' + '{{ LaravelLocalization::getCurrentLocale() }}', searchable: false},
                {
                    data: 'type',
                    name: 'type',
                    searchable: false,
