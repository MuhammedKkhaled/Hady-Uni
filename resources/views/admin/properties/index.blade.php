                    ...
                    <div class="col-sm-12">
                        <table class="table datatable table-bordered table-checkable dataTable no-footer dtr-inline "
                            ...
                            <tr>
                                ...
                                <th>{{ __("custom.Teacher Property title") }} </th>
                                <th>{{ __("custom.Teacher Property Description") }}</th>
                                <th> {{ __("custom.Property Type") }} </th>
    ...
    <script>
        ...
        let rolesTable = $('#{{$name}}-table').DataTable({
            ...
            columns: [
                ...
                {data: 'property_title_' + "{{ LaravelLocalization::getCurrentLocale() }}", name: 'property_title_' + "{{ LaravelLocalization::getCurrentLocale() }}"},
                {data: 'property_desc_' + "{{ LaravelLocalization::getCurrentLocale() }}", name: 'property_desc_' + "{{ LaravelLocalization::getCurrentLocale() }}", searchable: false},
                {data: 'type_' + "{{ LaravelLocalization::getCurrentLocale() }}", name: 'type_' + "{{ LaravelLocalization::getCurrentLocale() }}", searchable: false},
