            ...
            <form method="post" action="{{ route('admin.'.$name.'.update', $property->id) }}" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="property_title_en" name="property_title_en"  autofocus class="form-control" value="{{ old('property_title_en',$property->property_title_en) }}" required>
                    </div>

                    {{-- property_title --}}
                        <div class="form-group">
                            <label for="property_title_ar">{{ __("Custom.Property Title ar") }}<span class="text-danger">*</span></label>
                            <input type="text" id="property_title_ar" name="property_title_ar"  autofocus class="form-control" value="{{ old('property_title_ar',$property->property_title_ar) }}" required>
                        </div>

                    {{-- property_desc --}}
                    <div class="form-group">
                        <label for="property_desc_en"> {{ __("Custom.Property Description en") }}  <span class="text-danger">*</span></label>
                        <textarea name="property_desc_en" id="property_desc_en" class="form-control"  required> {{ $property->property_desc_en }}</textarea>
                    </div>
                    {{-- property_desc --}}
                    <div class="form-group">
                        <label for="property_desc_ar"> {{ __("Custom.Property Description ar") }}  <span class="text-danger">*</span></label>
                        <textarea name="property_desc_ar" id="property_desc_ar" class="form-control"  required> {{ $property->property_desc_ar }}</textarea>
                    </div>
