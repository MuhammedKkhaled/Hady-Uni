...
@section('content')
    <div class="card card-custom gutter-b example example-compact">
        <div class="card-header">
            <h3 class="card-title text-capitalize">{{ $name }} | Edit {{ $course->name }}</h3>
        </div>
        <div class="card-body">

            <form method="post" action="{{ route('admin.' . $name . '.update', $course->id) }}"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name_en" name="name_en" autofocus class="form-control"
                            value="{{ old('name_en', $course->name_en) }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="lecturers_en" name="lecturers_en" autofocus class="form-control"
                            value="{{ old('lecturers_en', $course->lecturers_en) }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="lecturers_ar" name="lecturers_ar" autofocus class="form-control"
                            value="{{ old('lecturers_ar', $course->lecturers_ar) }}" required>
                    </div>
                    {{-- Certificate ar --}}
                    <div class="form-group">
                        ...
                        <input type="date" id="date" name="date" autofocus class="form-control"
                            value="{{ old('date', $course->date) }}" required>
                    </div>
