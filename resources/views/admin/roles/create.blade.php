    ...
    <div class="card-body">
        <form class="form" action="{{ route('admin.'.$name.'.store') }}" method="POST">
            <div class="card-body">
                ...
                @php
                    $models = ['roles', 'admins', 'categories', 'blogs','affiliates','conferences','departments','journals','libraries','news','specifications','teachers','messages','students','galleries','links','accreditation',"ads",'characters','awards','sustainable','sustainablesgalleries','college','patents'];
                @endphp
