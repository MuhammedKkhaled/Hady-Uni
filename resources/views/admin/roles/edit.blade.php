    ...
    <div class="card-body">
        <form class="form" action="{{ route('admin.'.$name.'.update', $role->id) }}" method="POST">
            <div class="card-body">
                ...
                @php
                    $models = ['roles', 'admins', 'categories', 'blogs','affiliates','conferences','departments','journals','libraries','news','specifications','teachers','messages','students','galleries','links','accreditation',"ads",'characters','awards','sustainable','sustainablesgalleries','sustainablesgalleries','college','patents','statistics','studies','courses','reviews'];
                @endphp
