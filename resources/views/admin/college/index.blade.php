    ...
    <script>
        ...
        let rolesTable = $('#{{$name}}-table').DataTable({
            ...
            columns: [
                ...
                {data: 'book_name_' + '{{ LaravelLocalization::getCurrentLocale() }}', name: 'book_name_' + '{{ LaravelLocalization::getCurrentLocale() }}'},
                {data: 'book_number', name: 'book_number', searchable: false},
