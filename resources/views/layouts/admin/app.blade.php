...
<head>
    ...
    <link href="{{asset('admin_assets')}}/plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.0.6" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="{{asset('admin_assets')}}/css/themes/layout/header/base/light.css?v=7.0.6" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset('admin_assets')}}/css/themes/layout/header/menu/light.css?v=7.0.6" rel="stylesheet"
          type="text/css"/>
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label"
                     style="background-image: url('{{asset('admin_assets')}}/media/users/300_21.jpg');"></div>
