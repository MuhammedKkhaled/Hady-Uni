                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="comment-form">
                            <form action="{{ route('study.store') }}" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="col-md-12 row">
                                    <div class="single-form col-md-3">
                                        <input type="text"
                                            name="zip_code"style="text-align : {{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'end' : 'start' }}"
                                            placeholder="{{ __('custom.Postal code') }} "required>
                                    </div>
                                    <div class="single-form col-md-3">
                                        <input type="text"
                                            name="city"style="text-align : {{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'end' : 'start' }}"
                                            placeholder="{{ __('custom.City') }} "required>
                                    </div>
                                    <div class="single-form col-md-6">
                                        <select name ="living" style="text-align : {{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'end' : 'start' }}"required>
                                            <option selected="" disabled="">أختر {{ __('custom.Living') }}</option>
                                            ...
                                            <option value="Congo Democratic">Congo, Democratic Republic of the Congo</option>
                                ...
                                <div class="col-md-12 row">
                                    <div class="single-form col-md-6">
                                            <select name="nationality" style="text-align : {{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'end' : 'start' }}"required>
                                                <option selected="" disabled="">أختر {{ __('custom.Nationality') }}</option>
                                                <option value="Afghanistan">Afghanistan</option>
                                                <option value="Aland Islands">Aland Islands</option>
                                                <option value="Albania">Albania</option>
                                                <option value="Algeria">Algeria</option>
                                    ...
                                    <div class="single-form col-md-6">
                                        <select name="marital" style="text-align : {{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'end' : 'start' }}"required>
                                            <option selected="" disabled="">أختر {{ __('custom.marital status') }}</option>
                                            <option value="single">أعزب/عزباء</option>
                                            <option value="married">متزوج/ة </option>
                                            <option value="divorced">مطلق/ة</option>
                                            <option value="widow">ارمل/ة</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12 row">
                                    <div class="single-form col-md-6">
                                        <select name="qualification" style="text-align : {{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'end' : 'start' }}"required>
                                            ...
                                            <option value="أعدادية">أعدادية</option>
                                    ...
                                    <div class="single-form col-md-6">
                                        <input type="text"
                                            name="enterprise"style="text-align : {{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'end' : 'start' }}"required
                                            placeholder="{{ __('custom.Enterprise') }} ">
                                    </div>
                                </div>
                                <div class="col-md-12 row">
                                    <div class="single-form col-md-6">
                                        <input type="text"
                                            name="languages"style="text-align : {{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'end' : 'start' }}"
                                            placeholder="{{ __('custom.Languages') }} "required>
                                    </div>
                                    <div class="single-form col-md-6">
                                ...
                                <div class="col-md-12 row">
                                    <div class="single-form col-md-6">
                                        ...
                                        <input type="file"required
                                            name="personal"style="text-align : {{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'end' : 'start' }}">
                                    </div>
                                    <div class="single-form col-md-6">
                                        
                                        <label>صورة الجواز</label>
                                        <input type="file"required
                                            name="passport"style="text-align : {{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'end' : 'start' }}"
                                            >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 row">
                                    <div class="single-form col-md-6">
                                        ...
                                        <input type="file"required
                                            name="certificate"style="text-align : {{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'end' : 'start' }}">
                                    </div>
                                    <div class="single-form col-md-6">
                                ...
                                <div class="col-md-12 row">
                                    <div class="single-form col-md-6">
                                        <input type="text"
                                            name="in_iraq"style="text-align : {{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'end' : 'start' }}"
                                            placeholder="اذا كنت داخل العراق اذكر سبب تواجدك">
                                    </div>
                                    <div class="single-form col-md-6">
                                ...
                                <div class="col-md-12 row">
                                    <div class="single-form">
                                        <textarea style="text-align : {{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'end' : 'start' }}"
                                            placeholder="{{ __('custom.Skills and other details') }}" name="message"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="single-form">
